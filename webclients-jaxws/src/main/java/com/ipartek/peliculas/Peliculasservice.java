 ...
 * 
 */
@WebServiceClient(name = "peliculasservice", targetNamespace = "http://com.ipartek.formacion/types", wsdlLocation = "http://localhost:8080/webservices-jxws/peliculasws?wsdl")
public class Peliculasservice
    extends Service
{

    private final static URL PELICULASSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.ipartek.peliculas.Peliculasservice.class.getName());
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:8080/webservices-jxws/peliculasws?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/webservices-jxws/peliculasws?wsdl', retrying as a local file");
